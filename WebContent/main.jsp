				  ...
				  <div class="carousel-inner">
                    ...
                    <div class="quote" ><img src="images/top-rated.png"><h1 style="color:white;"><%=month%>월 <%=WeekDay%>주차 Top 5 - 5위</h1></div>
				    	...
				    	<p style="font-size:25px; display:inline-block;color:white;"><strong><%=al.get(4)%></strong></p>
						 ...
						 <a class="left carousel-control" onclick="$('#slide_').carousel('prev')" style="height:500px;color:white;"><img id="bbb" src="images/left.png" style="margin-top:200px; margin-left:-500px"></a>
						<a class="right carousel-control" onclick="$('#slide_').carousel('next')" style="height:500px;color:white;"><img id="bbb" src="images/right.png" style="margin-top:200px; margin-left:510px"></a>
				    </div>
		...
		<section id="partners">
			...
			<div class="container text-center">
				<div class="row">
					...
					<div class="col-md-3 mb-sm-30" style="width:25%">
						<div class="counter-item">
							<h2 class="stat-number" data-n="12">12</h2>
							<h6>Visitor</h6>
						</div>
					</div>
					<div class="col-md-3 mb-sm-30" style="width:25%">
